...
[![Build Status](https://travis-ci.org/Kdyby/Curl.svg?branch=nette-2.0)](https://travis-ci.org/Kdyby/Curl)
...
```sh
$ composer require kdyby/curl:~1.0.6
```
...
Lear more in the [documentation](https://github.com/Kdyby/Curl/blob/nette-2.0/docs/en/index.md).
